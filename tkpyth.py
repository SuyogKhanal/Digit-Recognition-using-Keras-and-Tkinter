...
cnn = load_model("F:\Handwriting recognition\mnist.h5")
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.x = self.y = 0
        # Creating elements
        self.canvas = tk.Canvas(self, width=300, height=300, bg = "white", cursor="cross",insertbackground='white')
    ...
    def classify_handwriting(self):
        ...
        speak("I guess    You have drawn " + str((digit)))
